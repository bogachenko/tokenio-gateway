...
| Storage and migration contract | `070`, `090`, migration ADR | `partial`: explicit cmd/migrate ownership and gateway validate-only startup verified; table/constraint mapping and migration failure matrix pending |
