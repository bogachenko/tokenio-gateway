...
| OpenAI-compatible public contract | `010`, `020`, `030`, `040`, `050`, `080`, `090` | `partial`: pricing_failed passthrough and complete billing response headers verified; minimum balance, auth recording and parser boundaries pending |
