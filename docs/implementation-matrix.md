...
| OpenAI-compatible public contract | `010`, `020`, `030`, `040`, `050`, `080`, `090` | `partial`: pricing_failed success passthrough verified; headers, admission, auth recording and parser boundaries pending |
