...
Статус документа: reconciled 2026-06-22 against `docs/spec/*`, `docs/adr/*`, package tree, wiring and automated test paths visible in the current repository snapshot.
...
- [x] Ollama native supports chat/generate/embeddings/tags transport, body-model extraction, usage extraction, failure classification and transport-to-ledger evidence.
...
- [x] Ollama chat/generate/embeddings/tags transport scenario exists at `integration/ollama_chat_generate_embeddings_tags_test.go`.
