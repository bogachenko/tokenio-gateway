...
func (f *stage10MajorRouterIDsFake) NewLocalRequestID() string { return "llmreq_test" }
func (f *stage10MajorRouterIDsFake) NewBillingChargeRequestID() string {
	return "billchg_test"
}
func (f *stage10MajorRouterIDsFake) NewAdminRequestID() string {
	f.mu.Lock()
	defer f.mu.Unlock()
	return f.id
}
