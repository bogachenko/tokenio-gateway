...
type telegramDeliveryObserverStub struct{}
...
type telegramFailedRetryObserverStub struct{}

func (telegramFailedRetryObserverStub) ObserveTelegramFailedRetryCycle(
	telegramfailedretry.Cycle,
) {
}
