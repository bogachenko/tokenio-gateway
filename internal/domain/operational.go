...
const (
	...
	RouteEventTypeCapacityRejected     RouteEventType = "capacity_rejected"
	RouteEventTypeForwardingStarted    RouteEventType = "forwarding_started"
	RouteEventTypeRetryScheduled       RouteEventType = "retry_scheduled"
	RouteEventTypeForwardingSucceeded  RouteEventType = "forwarding_succeeded"
	RouteEventTypeForwardingFailed     RouteEventType = "forwarding_failed"
