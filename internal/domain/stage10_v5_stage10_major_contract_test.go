...
func TestStage10V5AdminAuditActionContractValues(t *testing.T) {
...
func TestStage10V5AuditEntryJSONDoesNotInventSecretFields(t *testing.T) {
...
func TestStage10V5ResellerBaseURLValidationRejectsCredentialsAndNonCanonicalURLs(t *testing.T) {
	for _, valid := range []string{
		"https://provider.example",
		"http://localhost:11434/v1",
	} {
		if err := ValidateResellerBaseURL(valid); err != nil {
	...
	for _, invalid := range []string{
		...
		if err := ValidateResellerBaseURL(invalid); err == nil {
